...
A alimentação de energia da ponte H é provida de forma externa por uma fonte de alimentação CC de 5V dedicada para motores e bomba, compartilhando a mesma referência de terra (GND) com o microcontrolador Arduino.

### 3.2 Arquitetura do Software e Comunicação
...
### 3.3 Estratégia do Laço de Controle Automatizado
