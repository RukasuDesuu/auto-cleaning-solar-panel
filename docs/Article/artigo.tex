...
\begin{itemize}
    ...
    \item \textbf{Suportes dos Painéis (Panel Support):} Peças de interface que prendem os módulos fotovoltaicos de forma rígida à estrutura de suporte principal.
\end{itemize}
...
\begin{figure}[htbp]
    ...
    \IfFileExists{images/vista_explodida.png}{%
        \includegraphics[width=0.7\textwidth]{images/vista_explodida.png}%
    }{%
        \fbox{\parbox[c][6cm][c]{0.7\textwidth}{\centering\textit{Vista explodida da montagem (pendente)}}}%
    }
